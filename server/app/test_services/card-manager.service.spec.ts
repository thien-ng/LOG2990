...
// import { IModification, ModificationType } from "../../../common/communication/iSceneVariables";
...
describe("Card-manager tests", () => {
    ...
    it("should create a simple card when calling simpleCardCreationRoutine()", () => {

        cardManagerService.simpleCardCreationRoutine(imageRequirements, "aCardTitle");
    });

    // it("should return new length of 3D list after adding a card", () => {
    //     cardOperations.addCard(c2);
    //     cardOperations.addCard(c3);
