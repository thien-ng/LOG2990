export class Constants {
    // Constants for
    public static readonly BMP_HEADER_SIZE:             number =  54;
    public static readonly IS_A_DIFFERENCE:             number =   0;
    public static readonly PIXEL_24B_SIZE:              number =   3;
    public static readonly BASE_BMP_HEADER_SIZE:        number =  14;
    public static readonly BMP_INFOHEADER_SIZE:         number =  40;
    public static readonly WIDTH_OFFSET:                number =  18;
    public static readonly HEIGHT_OFFSET:               number =  22;
